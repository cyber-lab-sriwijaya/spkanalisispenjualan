...
<section role="main" class="content-body content-body-modern">
	<header class="page-header">
		<h2 class="font-weight-bold text-6">Data Produk</h2>
                    ...
                    <?php } ?>
							...
							<div class="card-body">
								<div class="row">
									<div class="col-sm-6">
										<div class="mb-3">
											<p class="card-category"><a href="form-produk.php" class="btn btn-warning"><i class="fas fa-plus"> Tambah Data</i></a></p>
										</div>
									</div>
								</div>
								<table class="table table-bordered table-striped mb-0" id="example">
									...
									<tbody>
										<?php 
											$no = 1;
											$produk = mysqli_query($conn, "SELECT produk.*, jenisproduk.namajenis as jenis FROM produk, jenisproduk WHERE jenisproduk.idjenis=produk.idjenis order by produk.idproduk asc ");
											while ($row = mysqli_fetch_assoc($produk)) { ?>
												<tr>
													...
													<td>
														<a href="include/p_produk.php?del&id=<?= $row['idproduk']; ?>" class="btn btn-danger" onclick="javascript: return confirm('Apakah anda yakin data ini akan dihapus?')" title="DELETE"><i class="fa fa-trash"></i></a>

														<a name="edit" id="edit" href="form-produk.php?edit&id=<?= $row['idproduk']; ?>" class="btn btn-success" title="EDIT"><i class="fa fa-edit"></i></a>
													</td>
												</tr>
